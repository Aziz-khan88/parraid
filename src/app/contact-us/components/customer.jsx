            ...
            <Container>
                ...
                <Row>
                    <Col md={6} className={`${styles.paddingTop} offset-md-6`}>
                        ...
                        <p>
                            Tailored to customer-specific configurations – can be acquired throughout the delivered products’ lifetime.
                        </p>
                    </Col>
                </Row>
            </Container>
