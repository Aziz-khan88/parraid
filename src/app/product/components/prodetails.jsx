    ...
    return (
        <section className={styles.ProDetails}>
            <Container>
                <Row>
                    <Col md={6}>
                        <div className={styles.mainImage} style={{ backgroundImage: `url(${BG.src})` }}>
                            <Image src={mainImage} alt="Slider" width={520} height={190} />
                        </div>
                        <div className={styles.imageSlide}>
                            {product.images.map((img, index) => (
                                ...
                                >
                                    <Image src={img.src} alt={`Slider ${index}`} width={150} height={55} />
                                </div>
                            ))}
                        </div>
                    </Col>
                            ...
                            <div className={styles.tabList}>
                                {tabs
                                    ...
                                    .map((tab) => (
                                        ...
                                        >
                                            <h4>{tab.label} <TabIcon /></h4>
                                        </div>
                                    ))}
                            </div>

                            <div className={styles.tabContent}>
                                {product[activeTab] ? product[activeTab] : (
